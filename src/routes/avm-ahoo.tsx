...
const OFFICER = AVM_OFFICERS.ahoo;

const TITLE = "Your Free Virtual Appraisal Report with Ahoo Khalessi | CTC Equity";
const DESC =
  "Scan-to-request landing page for Ahoo Khalessi's CTC Equity mailer. Enter the code from your letter and get a free virtual appraisal (AVM) report for your property.";

/**
 * /avm-ahoo : Ahoo Khalessi's dedicated mailer and QR campaign landing page.
 *
 ...
 */
export const Route = createFileRoute("/avm-ahoo")({
  head: () => ({
    meta: [
      { title: TITLE },
    ...
    links: [{ rel: "canonical", href: "https://ctcequity.com/avm-ahoo" }],
  }),
