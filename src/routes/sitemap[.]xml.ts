...
const NEW_LASTMOD = "2026-08-31";

const STATIC: Entry[] = [
  { path: "/", changefreq: "weekly", priority: "1.0" },
  { path: "/get-my-options", changefreq: "monthly", priority: "0.9" },
  { path: "/free-home-value-report", lastmod: NEW_LASTMOD, changefreq: "monthly", priority: "0.8" },
  ...
  { path: "/gas-station-loans", lastmod: NEW_LASTMOD, changefreq: "monthly", priority: "0.7" },
  ...
  { path: "/awards-accomplishments", lastmod: NEW_LASTMOD, changefreq: "monthly", priority: "0.7" },
