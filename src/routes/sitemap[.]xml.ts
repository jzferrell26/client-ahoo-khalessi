...
const DEFAULT_LASTMOD = "2026-08-31";

const STATIC: Entry[] = [
  { path: "/", changefreq: "weekly", priority: "1.0" },
  { path: "/get-my-options", changefreq: "monthly", priority: "0.9" },
  { path: "/free-home-value-report", changefreq: "monthly", priority: "0.8" },
  { path: "/heloc", changefreq: "monthly", priority: "0.9" },
  { path: "/million-dollar-heloc", changefreq: "monthly", priority: "0.9" },
  ...
  { path: "/business-purpose-bridge-loans", changefreq: "monthly", priority: "0.8" },
  { path: "/equity-based-loans-low-credit", changefreq: "monthly", priority: "0.8" },
  { path: "/fix-and-hold-loans", changefreq: "monthly", priority: "0.8" },
  { path: "/gas-station-loans", changefreq: "monthly", priority: "0.7" },
  { path: "/multifamily-loans", changefreq: "monthly", priority: "0.8" },
  { path: "/mixed-use-property-loans", changefreq: "monthly", priority: "0.7" },
  { path: "/large-balance-commercial-loans", changefreq: "monthly", priority: "0.7" },
  { path: "/ahoo-khalessi", changefreq: "monthly", priority: "0.8" },
  { path: "/ben-mokri", changefreq: "monthly", priority: "0.8" },
  { path: "/reviews", changefreq: "monthly", priority: "0.7" },
  { path: "/awards-accomplishments", changefreq: "monthly", priority: "0.7" },
