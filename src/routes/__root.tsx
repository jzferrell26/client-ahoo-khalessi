...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      {
        property: "og:title",
        content: "CTC Equity | HELOC, Fixed Second, DSCR & Self-Employed Mortgage Specialists",
      },
      {
      ...
      },
      {
        property: "og:image",
        content:
          "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/f62c9564-cdb5-4282-84c2-d783a98b6c2e/id-preview-583e7ef2--336999dc-5578-42bf-90ec-51cf0c3da9a3.lovable.app-1782333312111.png",
      },
      {
        name: "twitter:image",
        content:
...
const ROOT_PEOPLE_SCHEMA = [
  {
    ...
    sameAs: ["https://www.linkedin.com/in/ahookhalessi/"],
    award: [
